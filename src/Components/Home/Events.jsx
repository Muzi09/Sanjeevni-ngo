            ...
            <div className='flex justify-center mb-4'>
                <div>
                    <button className="relative inline-flex h-12 overflow-hidden rounded-full p-[4px] focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50">
                        ...
                        <span className="inline-flex h-full w-full cursor-pointer items-center justify-center rounded-full bg-red px-3 py-1 text-md font-medium text-white backdrop-blur-3xl">
                            Registration Closed!
                            Thanks for participating in MRCL
                        </span>
                    </button>
