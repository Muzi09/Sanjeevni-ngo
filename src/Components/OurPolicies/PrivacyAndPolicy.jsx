        ...
        <div className="py-3">
            <ul className="list-disc">
                <li className='pb-3'>
                    ...
                    <span>Welcome to Sanjeevani Foundation. We are committed to protecting your privacy. This Privacy Policy outlines how we collect, use, and safeguard your personal information when you visit our website [beingsanjeevanifoundation.co.in] and interact with our services.</span><br/>
                </li>
                <li className='pb-3'>
